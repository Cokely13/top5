  ...
  <div className="ranked-answers-list">
    {rankedAnswers.map((answer, index) => (
      <div key={index} className="ranked-answer-item">
        ...
        <div className={`rank-answer-bubble ${answer !== '__________' ? 'filled' : 'empty'}`}>
          {answer !== '__________' ? answer : ''}
            ...
            <p><i className="fas fa-star"></i> Your Score: <strong>{userScore}</strong></p>
            </div>

            {/* Display Strikes */}
            <div className="qotd-strikes">
              <p>
              <p><i className="fas fa-times-circle"></i> Strikes: <strong>{strikes} / {maxStrikes}</strong></p>
              </p>
              {strikes >= maxStrikes && (
